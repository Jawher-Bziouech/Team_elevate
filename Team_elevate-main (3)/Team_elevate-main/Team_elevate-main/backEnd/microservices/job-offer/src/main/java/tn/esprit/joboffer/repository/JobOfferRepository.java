...
public interface JobOfferRepository extends JpaRepository<JobOffer, Long> {
    ...
    // Cross-service: all offers for a given Entreprise MS company
    ...
    @Query("SELECT new tn.esprit.joboffer.dto.IndustryCountDto(j.industry, COUNT(j)) " +
            "FROM JobOffer j GROUP BY j.industry ORDER BY COUNT(j) DESC")
    List<IndustryCountDto> countJobOffersByIndustry();
}