...
public class JobOfferController {
    ...
    // All job offers for a specific Entreprise MS company
    @GetMapping("/byEntreprise/{entrepriseId}")
    public List<JobOfferResponse> getByEntreprise(@PathVariable Long entrepriseId) {
        return service.getByEntrepriseId(entrepriseId);
    }
